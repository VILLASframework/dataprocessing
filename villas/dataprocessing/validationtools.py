...
def convert_mpc_to_standard_timeseries(mpc_timeseries):
    """
    Convert the mpc results timeseries from dpsim to modelica timeseries
    :param mpc_timeseries: dict of mpc timeseries in kV, generated by the .mat result file from mpc
    :return: a list of mpc timeseries in V
    """
    ts_mpcList=[]
